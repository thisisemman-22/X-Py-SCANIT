...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    apiVersionAuthUserSubject.add(
      ApiVersionAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<ApiVersionAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  ApiVersionAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = ApiVersionAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    apiVersionAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
ApiVersionAuthUser? currentUser;
