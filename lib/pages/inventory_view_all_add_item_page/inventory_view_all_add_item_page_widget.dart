...
import 'inventory_view_all_add_item_page_model.dart';
export 'inventory_view_all_add_item_page_model.dart';

class InventoryViewAllAddItemPageWidget extends StatefulWidget {
  const InventoryViewAllAddItemPageWidget({super.key});

  @override
  State<InventoryViewAllAddItemPageWidget> createState() =>
      _InventoryViewAllAddItemPageWidgetState();
}

class _InventoryViewAllAddItemPageWidgetState
    extends State<InventoryViewAllAddItemPageWidget> {
  late InventoryViewAllAddItemPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InventoryViewAllAddItemPageModel());
                                                    ...
                                                    builder:
                                                      ...
                                                      return AlertDialog(
                                                        title: const Text(
                                                            'Add to Inventory'),
                                                        content: const Text(
                                                            'Do you want to add this product to the inventory?'),
                                                        actions: [
                                                          TextButton(
                                                            onPressed: () =>
                                                                Navigator.pop(
